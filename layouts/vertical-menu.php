            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="dashboard-saas.php" key="t-saas"><?php echo $language["Saas"]; ?></a></li>
                        <li><a href="dashboard-crypto.php" key="t-crypto"><?php echo $language["Crypto"]; ?></a></li>
                        <li><a href="dashboard-blog.php" key="t-blog"><?php echo $language["Blog"]; ?></a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="calendar.php" key="t-tui-calendar"><?php echo $language["TUI_Calendar"]; ?></a></li>
                        <li><a href="calendar-full.php" key="t-full-calendar"><?php echo $language["Full_Calendar"]; ?></a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ui-placeholders.php" key="t-placeholders"><?php echo $language["Placeholders"]; ?></a></li>
                        ...
                        <li><a href="ui-toasts.php" key="t-toasts"><?php echo $language["Toasts"]; ?></a></li>
